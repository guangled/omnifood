...
<html lang="en">
    ...
    <body>
        <header>
            <nav>
                <div class="row">
                    <a href="#" class="header-logo"><img src="resources/img/logo-white.png" alt="Omnifood logo" class="logo"></a>
                    <a href="#" class="header-logo-black"><img src="resources/img/logo.png" alt="Omnifood logo" class="logo-black"></a>
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    <img src="resources/img/lisbon-3.jpg" alt="Libson">
                    <h3>Libson</h3>
            ...
            <div class="row">
                ...
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="resources/img/customer-2.jpg" alt="Customer 1 photo">Joana Silva</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                        <cite><img src="resources/img/customer-3.jpg" alt="Customer 1 photo">Milton Chapman</cite>
                    </blockquote>    
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <form method="post" action="mailer.php" class="contact-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col span-2-of-3">
                                <input type="submit" value="Send it!" style="cursor:pointer">
                            </div>
                        </div>
                    </form>
                </div>
